...
public class BaseController {
    ...
    protected void setAMorPMAndActivePage(Model model, String activePage) {
        GregorianCalendar ca = new GregorianCalendar();
        if (ca.get(GregorianCalendar.AM_PM) == 0)
            model.addAttribute("AMPM", "上午好");
        else
            model.addAttribute("AMPM", "下午好");
        model.addAttribute("active", activePage);
    }
